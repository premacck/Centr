...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    final static int CLIENT_PLUS = 0x02;
    private final static int CLIENT_SNAPSHOT = 0x08;
    final static int CLIENT_ALL = CLIENT_GAMES | CLIENT_PLUS
            | CLIENT_SNAPSHOT;
    ...
    Dialog makeSimpleDialog(String title, String text) {
        if (mActivity == null) {
            logError("*** makeSimpleDialog failed: no current Activity!");
            return null;
        }
    ...
    static class SignInFailureReason {
